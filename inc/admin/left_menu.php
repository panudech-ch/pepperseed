...
<div class="container-fluid">
    ...
    <div class="row" style="margin-top: 50px;">
        ...
        <div class="col-12" style="text-align: left;padding-left: 10%;margin-bottom: 15%;">
            <h2><a href="menu_showOrderList.php?branch_id=<?php echo $branch_id ?>" class="HEADER_MENU-BebasBold">List (today) </a></h2>

        </div>
        <div class="col-12" style="text-align: left;padding-left: 10%;margin-bottom: 15%;">

            <h2><a href="menu_showOrderListAll.php?condition=all&branch_id=<?php echo $branch_id ?>" class="HEADER_MENU-BebasBold">List (all)</a></h2>
            <!--
            <h2 onclick="alert('Comingsoon...')"> <a href="#">List (all)</a></h2>
            -->
        ...
        <div class="col-12" style="text-align: left;padding-left: 10%;margin-bottom: 15%;">
            <h2><a href="reservation.php?&branch_id=<?php echo $branch_id ?>" class="HEADER_MENU-BebasBold" >Reservation</a></h2>
