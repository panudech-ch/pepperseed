...
<form id="form1" name="regis" method="post" enctype="multipart/form-data" action="edit_firstpage-sys.php?id=<? echo $id;?>" >
  ...
  <tr>
    <td valign="top">    
      <script type="text/javascript" src="../ckeditor/ckeditor.js"></script>
      <textarea cols="50" id="boxDetail" name="boxDetail" rows="22" ><? echo $data['firstpage']; ?></textarea>
