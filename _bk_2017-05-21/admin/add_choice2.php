...
<? if($id==''){?>
<form id="form1" name="regis" method="post" enctype="multipart/form-data" action="add_choice2-sys.php?cat_id=<? echo $cat_id; ?>&branch_id=<? echo $branch_id;?>" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" class="tbDesc"><b><a href="add_choice2.php?branch_id=<? echo $branch_id;?>&id=<? echo $dataTmp['id'];?>&cat_id=<? echo $dataTmp['cat_id'];?>"><img src="../images/bt-edit.png" width="40" border="0" align="absmiddle" /></a></b></td>
  </tr>
  	<? } ?>
    <? } ?>
</table>
...
?>
<form id="form1" name="regis" method="post" enctype="multipart/form-data" action="edit_choice2-sys.php?branch_id=<? echo $branch_id;?>&id=<? echo $id;?>&cat_id=<? echo $cat_id; ?>" >
	<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="right" valign="middle" width="100">Choice Name :</td>
