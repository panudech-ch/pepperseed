...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:12px; font-family:Arial, Helvetica, sans-serif; line-height:13px;">
  <tr>
    ...
    <td valign="top"><b><? echo $titleOrderID.str_pad($dataOrd['id'],6,"0",STR_PAD_LEFT);?></b></td>
  </tr>
  <tr>
    <td align="right" valign="top">Date :</td>
    <td valign="top"><b><?=$dataOrd['ord_date'];?> (<?=$dataOrd['ord_time'];?>)</b></td>
  </tr>
  <tr>
    <td align="right" valign="top">Name :</td>
    <td valign="top"><b><?=$dataOrd['ord_cname'];?></b></td>
  </tr>
  <tr>
    <td align="right" valign="top">Addr :</td>
    <td valign="top"><b><? if($dataOrd['ord_choicedelivery']!=1) { echo $dataOrd['ord_addr']." (".$area.")";} else {echo $area;}?></b></td>
  </tr>
  <tr>
    <td align="right" valign="top">Email :</td>
    <td valign="top"><b><?=$dataOrd['ord_mail']; ?></b></td>
  </tr>
  <tr>
    <td align="right" valign="top">Phone :</td>
    <td valign="top"><b><?=$dataOrd['ord_phone'];?></b></td>
  </tr>
  <tr>
    <td align="right" valign="top" style="padding-right:5px;">Comment</td>
    <td valign="top"><?=$dataOrd['ord_cmmt'];?></td>
  </tr>
  <tr>
    <td align="right" valign="top" style="padding-right:5px;">Payment</td>
    <td valign="top"><?=$dataOrd['ord_payment'];?></td>
  </tr>
</table>
<hr />
...
?>
		...
		<div style="padding:3px 0 0 20px;">
			...
			?>
($<? echo number_format($pp=(($data2['p_price']+$extraprice)*$data['p_qty']),2); $subTotal += $pp ?>)</td>
                   </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="right" style="padding:5px 5px 0 0;"><? echo "<b>$".number_format($charge_price,2)."</b>";  $subTotal+=$charge_price; ?></td>
  ...
  <tr>
    ...
    <td align="right" style="padding:5px 5px 0 0;"><b style="font-size:18px;">$<? echo number_format($subTotal,2);?></b></td>
  </tr>
  <tr>
