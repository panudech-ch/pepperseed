...
<div class="row container">
    <div class="large-12 columns logo">
    	<a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_url'); ?>/img/logo_big.png"></a>
    </div>
    <div class="large-12 columns slogan">
        <?php bloginfo('description'); ?>
    </div>
    <?php display_pepperseeds_navigation('large-12 columns nav'); ?>
</div>
