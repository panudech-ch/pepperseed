...
<? /**/if($_SESSION['sessionLogin']=="admin"){?>
    ...
    <a href="admin/add_gal.php?branch_id=<? echo $branch_id; ?>" class='example6'><img src="images/bt-edit.png" border="0" align="absmiddle" /></a>
    </div>
    <? } ?>        
...
?>
		<a href="images/imgupload/<? echo $dataGal['img_path']; ?>" class='gallery' title="<? echo $dataGal['titlename']; ?>"><img src="images/imgupload/<? echo $dataGal['img_path']; ?>" border="0"  width="165" height="110" class='imgGal' /></a>
<? } ?>        
