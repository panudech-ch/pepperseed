...
?>	
	<h2 style="font-size:18px; font-weight:700; color:#ffcc00; margin:5px 0; padding:0;"><? echo $data['titlename']; ?></h2>
    <a href="images/imgupload/<? echo $data['img_path'];?>" target="_blank"><img src="images/imgupload/<? echo $data['img_path'];?>" width="300px" border="0" style="margin-bottom:40px;" /></a>
