...
<!-- ***** END Goto Top ***** -->
	...
	<script language="JavaScript">
			...
			{			document.getElementById('QTYBox').style.display = 'none';
						...
						if (<?php echo $headHight; ?>> window.pageYOffset) {							
							posT = ((<?php echo $headHight; ?>)+x.top)+5;
						  } else {
...
<!--*************  Check Out *************-->	   
	   function CheckOut()
	   {
	   		window.location = 'menu3.php?show=yes&branch_id=<?php echo $branch_id;?>';
	   }	   
		...
		function scrollToAnchor(aid) {
			...
			<?php		
				...
				while($data = mysql_fetch_array($rsl)){
					...
					$catnameC = str_replace(")","-",$catnameC);
			?>
				$("#<?php echo $catnameC;?>").click(function() {
					 scrollToAnchor('cat<?php echo $cat_id;?>');
				});
			<?php } ?>
...
?>
<div style="position:absolute; z-index:-1; width:170px; margin:<?php echo $H; ?>px 0 0 0;">
<div id="lineT"><img src="images/spacer.gif" width="100%" height="1" /></div>
<div id="main"> 
<div style="margin-left:-25px;">

<?php echo $dataTmp['firstpage'];?>
				<?php if($_SESSION['ordertime']=='dinner'){ ?>
				<ul style="padding:0 0 0 25px; margin:0; font-size:14px; line-height:16px;">
                    ...
                    <?php				
                      ...
                      $rsl = mysql_query($sql);
                      while($data = mysql_fetch_array($rsl)){ ?>
                    <?php echo $data['area']; if($data['charge_price']>0){ echo "($".$data['charge_price'].")"; } echo ", "; ?>
                    <?php } ?>
                    </li>
                </ul>
                <?php } ?>
...
<a href="admin/add_cat.php?branch_id=<?php echo $branch_id; ?>" class='example6' style="color:#000;"><img src="images/bt-edit.png" border="0" align="absmiddle" width="45" /> Catagories</a>
<br />
<a href="admin/add_choice.php?branch_id=<?php echo $branch_id; ?>" class='example6' style="color:#000;"><img src="images/bt-edit.png" border="0" align="absmiddle" width="45" /> Choice Meat</a>
<br />
<!--<a href="admin/add_choice2.php?branch_id=<?php echo $branch_id; ?>" class='example6' style="color:#000;"><img src="images/bt-edit.png" border="0" align="absmiddle" width="45" /> Choice Noodle</a>
<br />-->
<a href="admin/edit_firstpage.php?id=<?php echo $idCondition;?>" class='example6' style="color:#000;"><img src="images/bt-edit.png" border="0" align="absmiddle" width="45" /> Conditions</a>
<br />
<a href="admin/add_delivery.php?branch_id=<?php echo $branch_id; ?>" class='example6' style="color:#000;"><img src="images/bt-edit.png" border="0" align="absmiddle" width="45" /> Delivery Area</a>
</div>
<hr />
<?php } ?>
    <ul style="margin:0; padding:0 0 0 15px; color:#000; ">
			<?php				
                    ...
                    while($data = mysql_fetch_array($rsl)){
						...
						$catnameC = str_replace(")","-",$catnameC);
            ?>  
                <li><a id="<?php echo $catnameC;?>" href="#" style="color:#000; font-size:17px;"><?php echo strtoupper($catname);?></a></li>
            <?php } ?>
		  </ul>
          </td>
...
<img src="images/orderBoxB-L.png" />
  ...
  <div id="lineT"><img src="images/spacer.gif" width="100%" height="1" /></div>
<div id="main">
<!--<div style="background-image:url(images/bgTA.png); width:437px; height:101px; position:absolute; margin:-20px 0 0 0px;"><h2 style="margin:15px 0 0 70px;"><span style="font-size:42px; color:#FFF;"><?php /*echo $typeMenu;*/ ?></span></h2></div>-->
		
<img src="images/spacer.gif" width="100%" height="15" />
        
<?php /*if($typeMenu=='Dinner Menu'){  ?>
...
<?php }*/ ?>
	...
	?>
				...
				?>
<?php if($numberList >1){ echo "<br /><br />"; }?>
<a name="cat<?php echo $cat_id; ?>"/>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="10"><img src="images/onlineBarCatL.png"/></td>
    <td background="images/onlineBarCatC.png"><h1 style="margin:0; padding:0; color:#000; font-size:28px;"><?php echo $catname;?>  
	<?php if(($cat_id==24)or($cat_id==26)or($cat_id==33)or($cat_id==35)){ echo "(Come with rice)";} // can delete ?>
    <img src="images/onlineCatIcoH2.png" width="10"  />  
	<?php /**/if($_SESSION['sessionLogin']=="admin"){?><a href="admin/add_menu.php?cat_id=<?php echo $cat_id; ?>" class='example6'><img src="images/bt-add.png" border="0" align="absmiddle" /></a><?php } ?></h1>
...
<br />
                            ...
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <h3>
                                <?php /**/if($_SESSION['sessionLogin']=="admin"){?>
                                <a href="admin/edit_menu.php?cat_id=<?php echo $cat_id; ?>&id=<?php echo $data2['id']; ?>" class='example6'><img src="images/bt-edit.png" width="40" border="0" align="absmiddle" /></a>
                                <a href="#" onClick="ConfirmChoice('<?php echo $data2['id'];?>', '<?php echo $branch_id;?>'); return false;"><img src="images/bt-del.png" border="0" width="40" align="absmiddle" /></a>
								<?php } ?>
                                
                                <?php  // if($cat_id>1){  if($chkFirst==""){$numberList=1; $chkFirst="Y";} echo $numberList.". ";} else {echo "• ";}****************** Edit ********************** // ?>	
                                <?php  echo $numberList.". "; ?>								
								<?php echo ucfirst(strtolower($data2['p_name']));?>
                                <?php 
                                ...
                                <div id="txtDesc"><?php echo $data2['p_desc'];?></div></td>
                                <td width="55" align="left" valign="top" id="lineRow">
                                                <?php if($data2['p_price'.$dinner]>0){?>
                                  <div <?php if($data2['p_desc']!=''){echo "style='margin:20px 0 0 0'";} else {echo "style='margin:10px 0 0 0'";}?>><b class="txtPrice">$<?php echo number_format($data2['p_price'.$dinner],2);?></b></div>
					                                <input type="text" name="choice<?php echo $numberList;?>" id="choice<?php echo $numberList;?>" value="" style="width:1px; height:1px; visibility:hidden;">
					                                <input type="text" name="choiceselect_<?php echo $numberList;?>" id="choiceselect_<?php echo $numberList;?>" value="" style="width:1px; height:1px; visibility:hidden;">
                                                <?php } else {  ?>
                                                    <?php 	
                                                        if($chkChoiceSelect != ''){   // Show Choice Extra					
                                                            ...
                                                            $numtmp = count($choice);
                                                    ?>         
                                                            <?php if($data2['p_desc']!=''){echo "<img src='images/spacer.gif' width='100%' height='15' />";} else {echo "<img src='images/spacer.gif' width='100%' height='8' />";} ?>
                                                            <select name="choice<?php echo  $numberList; ?>" id="choice<?php echo  $numberList; ?>" style="width:150px;">                      
                                                    <?php
                                                    ...
                                                    ?>
                                                              <option value="<?php echo $selectChoice;?>"><?php echo ucfirst(strtolower($itemtmp['choice_name']))." ($".number_format($itemtmp['choice_price'.$dinner],2).")";?></option>
                                                            <?php } ?>
                                                            </select>
                                                    <?php } ?> 
                                                    <?php 	
                                                        if($chkChoiceSelect2 != ''){   // Show Choice Extra						
                                                            ...
                                                            $numtmp = count($choice);
                                                    ?>         
                                                            <select name="choiceselect_<?php echo  $numberList; ?>" id="choiceselect_<?php echo  $numberList; ?>" style="width:150px;" >
                                                    <?php
                                                            ...
                                                            for($i=0;$i<$numtmp;$i++){	
                                                                ...
                                                                $itemtmp = mysql_fetch_array($rsltmp);
                                                    ?>
                                                                <option value="<?php echo $selectChoice;?>"><?php echo ucfirst(strtolower($itemtmp['choice_name']));?> <?php if($itemtmp['choice_price']>0){ echo " ($".number_format($itemtmp['choice_price'],2).")"; }?></option>
                                                            <?php } ?>
                                                            </select><br /><br />
                                                    <?php }  else { ?>
					                                		<input type="text" name="choiceselect_<?php echo $numberList;?>" id="choiceselect_<?php echo $numberList;?>" value="" style="width:1px; height:1px; visibility:hidden;">
													<?php }?> 
                                                <?php } ?>
                                <input type="text" id="txt<?php echo $numberList;?>" value="1" style="width:1px; visibility:hidden;">
                                </td>
                                <?php if($chkForOpen==1){  // 1 = Available  /  2 = Unavailable?>
                                <td width="40" valign="top" align="right" id="lineRow">
                                
                                <?php if($data2['show_takeaway']==1){  // ****************** Edit ********************** // ?>
                                    <img src="images/onlineBTCart.png" alt="Order" title="Order" border="0" class="btOrder<?php if($data2['p_desc']==''){echo "Nor";}?>" onClick="JavaScript:doCallAjax('<?php echo $data2['id'];?>', document.getElementById('txt<?php echo $numberList;?>').value, document.getElementById('choice<?php echo $numberList;?>').value, document.getElementById('choiceselect_<?php echo $numberList;?>').value);  AnimationAdd(); fncHideQTY(); " style="cursor: pointer;"  />
                                <?php } ?>
                                </td>
                                <?php } ?>
								<?php $numberList++;?>
