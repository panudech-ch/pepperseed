...
<body class="bg_booking" <?php if ($bgData != null) { ?>style="background: url(<?php echo $bgData['img_path']; ?>) no-repeat center center " <?php } ?>>
        ...
        <div class="content_aboutus">
            ...
            <div class="booking_table">
                <p class="booking_title">
                    ...
                    <?php if ($isAdmin) { ?> <a href="admin/edit_firstpage.php?id=<?php echo $topicData['id']; ?>" class="bg"><img src="images/bt-edit.png" border="0" align="absmiddle" /></a> <?php } ?>
                </p>
                <hr class="line_title">
                        ...
                        <form id="booking-form" method="post" enctype="multipart/form-data" action="booking.php">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-9" style="padding: 0;">
                                    <span>
                                        <select id="book_venue" name="book_venue" class="form-control" style="width: 90%; padding-top: 0px; padding-bottom: 0px; text-align-last: center; height: 30px" onchange="populateTime(this.value)">
                                            <option value="0"></option>
                                            <?php while ($rs = mysql_fetch_array($branchData)) {
                                                    ?>

                                                <option value="<?php echo $rs['ID']; ?>" <?php echo ($rs['ID'] == $venue) ? 'selected' : ''; ?>><?php echo $rs['BRANCH_NAME']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1 col-xs-6" style="padding: 0;">
                                    <span>
                                        <input id="book_numP" name="book_numP" type="number" min="1" max="99" class="long-book-num form-control" style="height: 30px" value="<?php echo $numP; ?>" />
                                    </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-9" style="padding: 0;">
                                    <span>
                                        <input id="book_date" name="book_date" type="text" class="form-control" style="width:90%; height: 30px" value="<?php echo $date; ?>" />
                                    </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-9" style="padding: 0;">
                                    <span>
                                        <select id="timepicker1" name="timepicker1" class="form-control" style="width: 90%; height: 30px; padding-top: 0px; padding-bottom: 0px; text-align-last: center;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-12" style="padding: 0;">
                                    <span><input id="book_name" name="book_name" type="text" class="longstyle form-control" style="height: 30px" value="<?php echo $name; ?>" /></span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-12" style="padding: 0;">
                                    <span><input id="book_contact" name="book_contact" type="tel" class="longstyle form-control" style="height: 30px" value="<?php echo $contact; ?>" /></span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-12" style="padding: 0;">
                                    <span><input id="book_email" name="book_email" type="email" class="longstyle form-control" style="height: 30px" value="<?php echo $email; ?>" /></span>
                            ...
                            <div class="Gotham12" style="padding-top: 5%">*Booking information required. <?php echo "BBBBBBBBBBBBBBBBB : ".$msg; ?></div>
                    ...
                    <?php } else { ?>
                        <div class="cart-data">
                            <div class="cart-data-layout" style="padding: 30px">
                                ...
                                <p>
                                    <div style="color: black; font-size: large; text-align: right;font-family: 'GothamBold'"><?php echo $msgthk; ?></div>
                                </p>
                            </div>
                        </div>
                    <?php } ?>
