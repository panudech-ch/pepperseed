...
<?php	$branch_id = $_GET['branch_id'];
	...
	$result=mysql_query($sqlAdd);
		...
		?>
        <SCRIPT LANGUAGE="JavaScript">window.location="menu4.php?OrderID=<?php echo $intOrderID;?>&branch_id=<?php echo $branch_id; ?>&ordertime=<?php echo $ordertime;?>";</script>
<?php
	} else { ?>
		<SCRIPT LANGUAGE="JavaScript">window.location="menu.php?branch_id=<?php echo $branch_id; ?>&ordertime=<?php echo $ordertime;?>";</script>
<?php	}	
	// End Data
?>
