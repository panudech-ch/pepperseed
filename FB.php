...
?>
    ...
    <?php if($_SESSION['sessionLogin']=="admin"){
			if($dataFB['f_show']=='0'){ ?>
			<a href="admin/showfeedback.php?value=1&id=<?php echo $dataFB['id']; ?>"><img src="images/f_hidden.png" align="absmiddle" /></a>
	<?php	} else { ?>
			<a href="admin/showfeedback.php?value=0&id=<?php echo $dataFB['id']; ?>"><img src="images/f_show.png" align="absmiddle" /></a>
			
	<?php	}	?>
    <?php } ?>
    <b><?php echo $dataFB['f_name']; ?></b><br />
    <?php echo $dataFB['f_cmmt']; ?><br />
    <?php  $date=explode("-",$dataFB['f_date']); echo $date[2]." ".$monthshow[intval($date[1])]." ".$date[0];?>
<?php } } ?>
