...
<?php
    ...
    if(isset($_POST['submit'])){
        if(!empty($venue) && !empty($numP) && !empty($date) && !empty($time) && !empty($name) && !empty($contact) && !empty($email)){
            ...
            $err_venue = empty($venue) ? "Please Select Venue." : '';
            $err_numP = empty($numP) ? "Please Input Number Of People." : '';
            $err_date = empty($date) ? "Please Select Date." : '';
            $err_time = empty($time) ? "Please Select Time." : '';
            $err_name = empty($name) ? "Please Input Your Name." : '';
            $err_contact = empty($contact) ? "Please Input Your Contact Number." : '';
            $err_email = empty($email) ? "Please Input Your Email." : '';
        }
    }
?>
