                ...
                <?php }else{ ?>
                    ...
                    <div class="row credit-charge" style="display: none;">
                        <div class="col-lg-6 col-xs-9">
                            <span class="cart-left"
                                  style="font-family: 'TheMixBold'; font-size: 21.29px;">
                                &nbsp;<b style="font-family: 'GothamLight'; font-size: 15.00px;">Credit Charge 1.5%</b></span>
                        </div>
                        <div class="col-lg-6 col-xs-3">
                    ...
                    <div class="row" style="font-family: 'TheMixBold';">
                        ...
                        <div class="col-lg-6 col-xs-6">
                            <button class="cart-right" type="submit" id="checkout-button" onclick="checkoutSubmit()">CHECK OUT</button>
                        </div>
                    </div>
                    </p>
                    <div class="clearfixed"></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#payment-detail')
            .load('inc/test-payment-pickup.php')
            .css({opacity: 0})
            .animate({opacity: 1});
        ...
        $('#mode-delivery').change(function (e) {
            ...
            if (parseFloat(total) >= parseFloat(35)) {
                document.getElementById('total_charge').value = 0;
                $('#payment-detail')
                    .load('inc/test-payment-delivery.php')
                    .css({opacity: 0})
                    .animate({opacity: 1});
            } else {
    ...
    function addCreditCharge(){
        var total = $('#cartTotal').val();
        var creditChargeValue = total * 0.015;
    ...
    function submitOrder() {
        ...
        $.ajax({
            type: 'POST',
            url: 'inc/test-add-payment-sys.php',
            data: {
                ...
                total_credit_charge: document.getElementById('total_credit_charge').value,
            },
            cache: false,
            success: function (msg) {
                if (msg.trim() == "ERROR") {
                    ...
                    $('.cart-data').load('inc/test-order_confirm.php?ord_id=' + msg.trim());
                    $('#divLoading').css('display', 'none');
                }
            }
        });
