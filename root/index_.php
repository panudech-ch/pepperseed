  ...
  <div id="content">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <tr>
        <td class="bg65"><img src="images/spacer.gif" width="100%" height="10" /></td>
        <td class="bg65">
        	<h2>Admin Login @ <?php echo $shopBranch[$_SESSION['adminBranchID']]; ?></h2>
        <div style="width:31%; float:left; padding:0 1%;">
        	<img src="images/icoList.png" /> <a href="menu_showOrderList.php?branch_id=<?php echo $_SESSION['adminBranchID']; ?>" style="color:#C33;"> Show Order List (Today)</a><br />
        	<img src="images/icoList.png" /> <a href="menu_showOrderList.php?condition=all&branch_id=<?php echo $_SESSION['adminBranchID']; ?>" style="color:#C33;">Show Order List (All)</a>
        </div>
        <div style="width:62%; float:left; padding:0 1%;" class="txtRed">
        
        	<?php  // Check Order Online  Avialable / Unavialable
          ...
          <a href="admin/availableonline.php?value=1&branch_id=<?php echo $_SESSION['adminBranchID']; ?>&opentime=lunch" style="color:#C33;">
            	<?php if($chkOpenOnlineLunch==1){ echo "<u>";}?> Available <?php if($chkOpenOnlineLunch==1){ echo "</u>";}?>
          </a> / <a href="admin/availableonline.php?value=0&branch_id=<?php echo $_SESSION['adminBranchID']; ?>&opentime=lunch" style="color:#C33;">
            	<?php if($chkOpenOnlineLunch!=1){ echo "<u>";}?> Unavailable<?php if($chkOpenOnlineLunch!=1){ echo "</u>";}?>
            </a>
            ] <br />
            -->
            
        	<img src="images/icoList.png" /> Order Online <!--<b>(DINNER)</b>--> [ 
          <a href="admin/availableonline.php?value=1&branch_id=<?php echo $_SESSION['adminBranchID']; ?>&opentime=dinner" style="color:#C33;">
            	<?php if($chkOpenOnline==1){ echo "<u>";}?> Available <?php if($chkOpenOnline==1){ echo "</u>";}?>
          </a> / <a href="admin/availableonline.php?value=0&branch_id=<?php echo $_SESSION['adminBranchID']; ?>&opentime=dinner" style="color:#C33;">
            	<?php if($chkOpenOnline!=1){ echo "<u>";}?> Unavailable<?php if($chkOpenOnline!=1){ echo "</u>";}?>
            </a>
            ] <br />
            
            
            
		  <b class="txtRed" style="font-size:14px;"><?php echo $txt = $_GET['txt']; ?></b>
        </div>
         </td>
        <td class="bg65"><img src="images/spacer.gif" width="100%" height="10" /></td>
      </tr>
    ...
    <div id="slideshow">
                    <?php  $i=0;
						...
						while($dataGal = mysql_fetch_array($rslGal)){
							$i++;
					?>
                    <img src="images/imgupload/<?php echo $dataGal['img_path'];?>" <?php if($i==1){ echo "class='active'";} ?> />
                    <?php } ?>
      </div>
    <!-- End Script ImgFade -->
     </div>
