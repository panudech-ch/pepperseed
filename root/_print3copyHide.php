                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:12px; font-family:Arial, Helvetica, sans-serif; line-height:13px;">
                    ...
                    <tr>
                        ...
                        <?php if(($ord_payment!="Cash") && ($ord_payment!="")){
                            ...
                            $no = "XXXX XXXX XXXX ".substr(trim($arrNo[0]), -4); // pay no.
                            $printNew = $pay.'<br>No.'.$no.'<br>Expiry Date XX/XX';
                            ?>
                            <td valign="top" style="font-size:11px;!important;"><?php echo $printNew;?></td>
                        <?php } else { ?>
